<div id="updateRecordModal_{{ $data->id }}"
    ...
    <div
        ...
        <div
            ...
            <span class="text-lg ">Update Record</span>
            <img
                src="{{ asset('assets/images/clsoe.svg') }}"
                onClick="toggleUpdateRecordModal('{{ $data->id }}')"
        ...
        <form method="post" action={{ '/update-record' }} enctype="multipart/form-data">
            ...
            <div class="grid text-xs px-4 pb-4 pt-2 gap-3">
                ...
                <div>
                    <div class="grid">
                            <span
                                ...
                                Address:</span>
                        <input type="email"  name="email_address" value="{{ $data->email_address }}"
                               class="w-full p-3 rounded-md bg-[#ffffff04] outline-none hover:bg-[#ffffff08] border border-lightPrimary active:border-none focus:border-secondary placeholder:text-xs dark:bg-slate-800" />
                ...
                <div class="grid">
                    ...
                    <div class="relative">
                        <input
                            type="number" name="phone_number" value="{{ $data->phone_number }}"
                ...
                <div>
                    <div class="grid">
                        ...
                        <div class="relative">
                            <input type="file" name ="cv" value="{{ $data->cv }}"
                    ...
                    <div class="grid">
                        ...
                        <div class="relative">
                            <div
                                ...
                                onClick="togglePasswordInput('{{ $data->id }}')">
                                    <span
                            ...
                            <input type="password"
                                   id="passwordInput_{{ $data->id }}" name="password"
                                   class="w-full p-3 rounded-md bg-[#ffffff04] hover:bg-[#ffffff08] border border-lightPrimary active:border-none focus:border-secondary outline-none placeholder:text-xs dark:bg-slate-800" />
                        </div>
                    </div>
                    @error('password')
